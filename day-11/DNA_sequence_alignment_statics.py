...
def print_length_error_report(name1,
                              sequence1,
                              name2,
                              sequence2):
    print("-" * 50)
...
def print_invalid_report(name1,
                         sequence1,
                         errors1,
                         name2,
                         sequence2,
